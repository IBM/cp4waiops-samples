...
Once you have carefully reviewed and decided on what to delete, you can move forward to the next step and update the `uninstall-cp4waiops-props.sh` file with your preferences.
