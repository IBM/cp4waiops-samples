...
## Resource size for 3.3 **No change for 3.4**
...
display_help() {
   echo "**************************************** Usage ********************************************"
   echo
   echo " This script ensures that you have met the technical prerequisites for IBM Cloud Pak for AIOps version 3.4 ."
   echo
...
echo
log $INFO "Starting IBM Cloud Pak for Watson AIOps AI Manager prerequisite checker v3.4..."
echo
    ...
    spec:
      ...
      template:
        ...
        spec:
          ...
          containers:
          - name: testimage
            image: cp.icr.io/cp/cp4waiops/ai-platform-api-server@sha256:dceecb237837727f7c8fc9645c2c7c5aad12e1d1424b541019da89c6d8e15c6a
